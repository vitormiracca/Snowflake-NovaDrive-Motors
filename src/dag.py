...
def postgres_to_snowflake_etl():
    ...
    for table_name in table_names:
        ...
        def get_max_primary_key(table_name: str):
            """
            Função que retorna o último ID inserido no Snowflake. (útil para a carga incremental as seguir).
            """
        ...
        def load_incremental_data(table_name: str, max_id: int):
            """
            Função que carrega dados de forma incremental no Snowflake.
            Utiliza o argumento max_id anterior, para carregar os dados posteriores a este ID.
            """
